ESP32 mikrodenetleycisi kullanarak LM35 ile okunan sıcaklık değerleri istenilen sıcaklığı aştığında SMTP ile mail gönderme ile ilgili örnek yapılmıştır.
